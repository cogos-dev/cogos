...
| `{branch-disagreement}/.cog/.state/constellation.db?mode=ro&_journal_mode=WAL&_busy_timeout=3000` | doctorIndexHealth (`sql.Open(sqlite3)`) | internal/engine/cli_doctor.go:1028 | internal:engine |
| `{branch-disagreement}/.cog/bin/cogos` | (*selfUpdater).runApply (`os.Rename`) | internal/engine/cli_selfupdate_unix.go:299 | internal:engine |
| `{branch-disagreement}/.cog/bin/cogos` | (*selfUpdater).runApply (`os.Rename`) | internal/engine/cli_selfupdate_unix.go:303 | internal:engine |
| `{branch-disagreement}/.cog/bin/cogos.bak.tmp` | copyFileMode (`os.OpenFile`) | internal/engine/cli_selfupdate_unix.go:730 | internal:engine |
| `{branch-disagreement}/.cog/bin/cogos.bak.tmp` | copyFileMode (`io.Copy`) | internal/engine/cli_selfupdate_unix.go:734 | internal:engine |
| `{branch-disagreement}/.cog/bin/cogos.bak` | copyFileMode (`os.Rename`) | internal/engine/cli_selfupdate_unix.go:747 | internal:engine |
...
| `dirname({branch-disagreement}/.zshrc)` | addCogBinToPath (`os.MkdirAll`) | internal/engine/cli_install_unix.go:44 | internal:engine |
| `{branch-disagreement}/.zshrc` | addCogBinToPath (`os.OpenFile`) | internal/engine/cli_install_unix.go:48 | internal:engine |
...
| `{branch-disagreement}` | writeExperimentTemplate (`os.WriteFile`) | internal/engine/experiment.go:230 | internal:engine |
...
| `dirname({branch-disagreement})` | atomicWriteMemoryFile (`os.CreateTemp`) | internal/engine/memory_sections.go:353 | internal:engine |
| `{branch-disagreement}` | atomicWriteMemoryFile (`os.Rename`) | internal/engine/memory_sections.go:375 | internal:engine |
...
| `dirname({branch-disagreement})` | newRotatingWriter (`os.MkdirAll`) | internal/engine/rotating_writer.go:47 | internal:engine |
| `{branch-disagreement}` | newRotatingWriter (`os.OpenFile`) | internal/engine/rotating_writer.go:50 | internal:engine |
| `{branch-disagreement}` | (*rotatingWriter).Write (`os.OpenFile`) | internal/engine/rotating_writer.go:89 | internal:engine |
| `{branch-disagreement}.1` | (*rotatingWriter).rotateLocked (`os.Rename`) | internal/engine/rotating_writer.go:137 | internal:engine |
| `{branch-disagreement}` | (*rotatingWriter).rotateLocked (`os.OpenFile`) | internal/engine/rotating_writer.go:141 | internal:engine |
...
| `{branch-disagreement}` | spawnDetachedUpdater (`os.OpenFile`) | internal/providers/selfupdate/spawn_unix.go:43 | provider:selfupdate |
