...
Total sites: 238  (cog: 101, home: 4, elsewhere: 13, unanchored: 77, dynamic: 43)
...
| `<call:reconcileResolveWorkspace>/.cog/.state/constellation.db?mode=ro&_journal_mode=WAL&_busy_timeout=3000` | doctorIndexHealth (`sql.Open(sqlite3)`) | internal/engine/cli_doctor.go:1028 | internal:engine |
| `<WorkspaceRoot>/.cog/ledger/unknown/events.jsonl` | runEmitHookStyle (`engine.AppendEvent(bucket)`) | internal/engine/cli_emit.go:189 | internal:engine |
...
| `dirname(<WorkspaceRoot>/.cog/mem/{input.Path})` | atomicWriteMemoryFile (`os.CreateTemp`) | internal/engine/memory_sections.go:353 | internal:engine |
| `<WorkspaceRoot>/.cog/mem/{input.Path}` | atomicWriteMemoryFile (`os.Rename`) | internal/engine/memory_sections.go:375 | internal:engine |
...
| `dirname(<WorkspaceRoot>/.cog/run/kernel.log.jsonl)` | newRotatingWriter (`os.MkdirAll`) | internal/engine/rotating_writer.go:47 | internal:engine |
| `<WorkspaceRoot>/.cog/run/kernel.log.jsonl` | newRotatingWriter (`os.OpenFile`) | internal/engine/rotating_writer.go:50 | internal:engine |
| `<WorkspaceRoot>/.cog/run/kernel.log.jsonl` | (*rotatingWriter).Write (`os.OpenFile`) | internal/engine/rotating_writer.go:89 | internal:engine |
| `<WorkspaceRoot>/.cog/run/kernel.log.jsonl.1` | (*rotatingWriter).rotateLocked (`os.Rename`) | internal/engine/rotating_writer.go:137 | internal:engine |
| `<WorkspaceRoot>/.cog/run/kernel.log.jsonl` | (*rotatingWriter).rotateLocked (`os.OpenFile`) | internal/engine/rotating_writer.go:141 | internal:engine |
...
| `{root}/.cog/run/selfupdate.log` | spawnDetachedUpdater (`os.OpenFile`) | internal/providers/selfupdate/spawn_unix.go:43 | provider:selfupdate |
...
| pattern | writer func | file:line | subsystem |
|---|---|---|---|
| `dirname(<Home>/Library/LaunchAgents/com.cogos.mlx-{name}.plist)` | (*MLXSupervisedProvider).writePlist (`os.MkdirAll`) | internal/engine/provider_mlx_supervised.go:432 | internal:engine |
| `<Home>/Library/LaunchAgents/com.cogos.mlx-{name}.plist` | (*MLXSupervisedProvider).writePlist (`os.WriteFile`) | internal/engine/provider_mlx_supervised.go:458 | internal:engine |
| `<Home>/workspaces/first-instruments-runs/{runID}` | RunDir (`os.MkdirAll`) | internal/testkernel/experiment/manifest.go:41 | internal:testkernel |
| `<Home>/workspaces/first-instruments-runs/{runID}/observations.jsonl` | NewObservationWriter (`os.OpenFile`) | internal/testkernel/experiment/manifest.go:103 | internal:testkernel |
...
| `dirname(<call:detectShellRC>)` | addCogBinToPath (`os.MkdirAll`) | internal/engine/cli_install_unix.go:44 | internal:engine |
| `<call:detectShellRC>` | addCogBinToPath (`os.OpenFile`) | internal/engine/cli_install_unix.go:48 | internal:engine |
| `<call:cogBinDir>/cogos` | (*selfUpdater).runApply (`os.Rename`) | internal/engine/cli_selfupdate_unix.go:299 | internal:engine |
| `<call:cogBinDir>/cogos` | (*selfUpdater).runApply (`os.Rename`) | internal/engine/cli_selfupdate_unix.go:303 | internal:engine |
...
| `<call:cogBinDir>/cogos.bak.tmp` | copyFileMode (`os.OpenFile`) | internal/engine/cli_selfupdate_unix.go:730 | internal:engine |
| `<call:cogBinDir>/cogos.bak.tmp` | copyFileMode (`io.Copy`) | internal/engine/cli_selfupdate_unix.go:734 | internal:engine |
| `<call:cogBinDir>/cogos.bak` | copyFileMode (`os.Rename`) | internal/engine/cli_selfupdate_unix.go:747 | internal:engine |
...
| `{path}` | writeExperimentTemplate (`os.WriteFile`) | internal/engine/experiment.go:230 | internal:engine |
...
| `dirname({dir}/{dir}/{dir}/{dir}/{dir}/{dir}/<max-depth>/<max-depth>/<max-depth>)` | runBlobsCmd (`os.MkdirAll`) | internal/engine/blobs_cmd.go:251 | internal:engine |
| `{dir}/{dir}/{dir}/{dir}/{dir}/{dir}/<call:findWorkspaceRoot>/<max-depth>/<max-depth>` | runBlobsCmd (`os.WriteFile`) | internal/engine/blobs_cmd.go:255 | internal:engine |
...
| `<call:fmt.Sprintf>` | runDebugProfileCmd (`os.Create`) | internal/engine/cli_debug.go:91 | internal:engine |
| `<call:fmt.Sprintf>` | runDebugProfileCmd (`io.Copy`) | internal/engine/cli_debug.go:98 | internal:engine |
