// events.go — cog.sync.* event types and emission helpers for BEP transport.
//
// Extracted from apps/cogos/bep_events.go. The SyncEventToBusData function
// remains in the kernel (bep_events.go) because it depends on the CogBlock type.
