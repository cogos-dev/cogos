...
type CogFieldNode = cogfield.Node
type CogFieldEdge = cogfield.Edge
type CogFieldStats = cogfield.Stats
type CogFieldGraph = cogfield.Graph

// normalizeEntityType delegates to pkg/cogfield.
var normalizeEntityType = cogfield.NormalizeEntityType

// inferSector delegates to pkg/cogfield.
var inferSector = cogfield.InferSector

// strengthFromMetrics delegates to pkg/cogfield.
...
// sessionJSONLEvent is a type alias — canonical type lives in pkg/cogfield.
...
// extractTimestamp delegates to pkg/cogfield.
var extractTimestamp = cogfield.ExtractTimestamp

// busRegistryEntry is a type alias — canonical type lives in pkg/cogfield.
...
// parseCSVSet delegates to pkg/cogfield.
var parseCSVSet = cogfield.ParseCSVSet

// filterCogFieldNodes delegates to pkg/cogfield.
var filterCogFieldNodes = cogfield.FilterNodes

// bfsCogFieldSubgraph delegates to pkg/cogfield.
var bfsCogFieldSubgraph = cogfield.BFSSubgraph

// computeCogFieldStats delegates to pkg/cogfield.
var computeCogFieldStats = cogfield.ComputeStats
